            ...
            {isAdminRoute && <>
                <div className='top-16'>
                    <button
                        ...
                        type="button"
                        className={`sm:hidden absolute z-50 top-8 left-4 inline-flex items-center p-2 mt-10 ms-3 text-sm     ${isSidebarOpen ? "opacity-100 bg-gray-200" : "opacity-40"} hover:opacity-100 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600`}>
                            ...
                            <ul className="space-y-2 font-medium pt-9 sm:pt-0 mt-5 ml-4">
                                ...
                                <li>
                                    <Link href={`/admin/products`} className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                        ...
                                        <span className="flex-1 ms-3 whitespace-nowrap">List Products</span>
                                    </Link>
                                </li>

                                <li>
                                    <Link href={`/admin/addproducts`} className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                        <svg className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20">
                                            <path d="M17 5.923A1 1 0 0 0 16 5h-3V4a4 4 0 1 0-8 0v1H2a1 1 0 0 0-1 .923L.086 17.846A2 2 0 0 0 2.08 20h13.84a2 2 0 0 0 1.994-2.153L17 5.923ZM7 9a1 1 0 0 1-2 0V7h2v2Zm0-5a2 2 0 1 1 4 0v1H7V4Zm6 5a1 1 0 1 1-2 0V7h2v2Z" />
                                        </svg>
